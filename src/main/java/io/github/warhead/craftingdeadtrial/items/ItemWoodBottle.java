...
public class ItemWoodBottle extends ItemCD {

    public ItemWoodBottle(int id) {
        super(id);
        this.setUnlocalizedName(Strings.RESOURCE_PREFIX + Strings.WOOD_BOTTLE_NAME);
        this.setMaxDamage(2);
    ...
    public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer) {
        ...
        MovingObjectPosition mop = this.getMovingObjectPositionFromPlayer(par2World, par3EntityPlayer, par1ItemStack.getItemDamage() == 2);
        if (mop == null) {
            if (par1ItemStack.getItemDamage() < 2 && handler != null && handler.isThirsty()) {
            ...
            } else if (par1ItemStack.getItemDamage() < 2 && handler != null && handler.isThirsty()) {
                par3EntityPlayer.setItemInUse(par1ItemStack, this.getMaxItemUseDuration(par1ItemStack));
            }
        }
        return par1ItemStack;
